---
name: de1-optical-alignment
description: Track 1 rail — optical vs. mathematical alignment. Rules for when and how far to nudge icons, shapes, and text off mathematical center to compensate for human optical weight. Use whenever centering icons in buttons, aligning icons with text, mixing circles/triangles/squares at "equal" size, vertically centering text in badges/buttons, or whenever a user says something "looks off-center" or "looks off" despite being mathematically centered. Also apply silently whenever generating button, badge, icon, or logo layout code.
version: 0.1.0
tags: [design-engineering, visual-taste, aesthetics]
inputs:
  - name: interface
    description: The UI, screen, or visual system being designed or reviewed.
    required: true
---
